                    ...
                    <div class="col-sm-10 col-md-9 col-lg-7 col-xl-6 my-5">
                        <form action="includes/login_processor.php" method="POST" class="bg-light rounded shadow py-5 px-4 px-sm-5">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" name="username" value="" id="form1Example1" class="form-control" required/>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="password" name="password" value="" id="form1Example2" class="form-control" required/>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col text-center">
                                    <!-- Simple link -->
                                    <a href="#!" class="astalavee-color">Forgot password?</a>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <p>Not a member? <a href="#" class="astalavee-color">Register</a></p>
                                <p>or sign up with:</p>
